...
def main():
    fastq = "/mnt/sda/rna-basecaller/experiments/decode/global-n-gram/4_Align/ngram-2.fastq"
    # fastq = sys.argv[1]
    ...
    # Load coding reads
    coding_file = "/mnt/sda/rna-basecaller/experiments/decode/global-n-gram/0_TestData/heart/coding_reads.txt"
    with open(coding_file, "r") as f:
        coding_reads = [line.rstrip('\n') for line in f]
