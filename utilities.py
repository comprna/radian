...
if __name__ == "__main__":
    data_files = glob("/g/data/xc17/Eyras/alex/mnt-sda-backup/singleton-dataset-generation/dRNA/4_8_NNInputs/0_3_CreateTrimmedSortedTFRecords/curriculum/individual/stage_L20/train/*.tfrecords")
